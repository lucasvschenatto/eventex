System.register(["angular2/core", "angular2/http", "rxjs/Observable", "rxjs/Rx", "../base-service"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AssociateService = (function (_super) {
                ...
                AssociateService.prototype.getList = function () {
                    return this._http.get(this._apiUrl)
                        .map(function (res) { return res.json(); })
                        .catch(this.throwError);
                };
                AssociateService.prototype.save = function (domain) {
                ...
                AssociateService.prototype.throwError = function (response) {
            ...
            exports_1("AssociateService", AssociateService);
        }
    }
});
