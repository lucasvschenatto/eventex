...
var _createScopeFields = function(scope, uiInputAPI, editMode){
	...
	scope.place                 = uiInputAPI.makeField(false,  editMode, _help.place        ,_label.place         , _ph.place         ,"text");
	scope.address               = {};
...
var _setErrors = function(scope, status){
	...
	scope.status.address.street       = status.address.street       ? "has-error" : "";
	scope.status.address.number       = status.address.number       ? "has-error" : "";
	scope.status.address.complement   = status.address.complement   ? "has-error" : "";
	scope.status.address.neighborhood = status.address.neighborhood ? "has-error" : "";
	scope.status.address.city         = status.address.city         ? "has-error" : "";
	scope.status.address.state        = status.address.state        ? "has-error" : "";
	scope.status.address.country      = status.address.country      ? "has-error" : "";
	scope.status.address.cep          = status.address.cep          ? "has-error" : "";
}
...
angular.module("eventex").controller("activityDetailsCtrl", function($scope, $modalInstance,uiInputAPI, activitiesAPI, data){
	...
	_createScopeFields($scope, uiInputAPI, $scope.editMode);
