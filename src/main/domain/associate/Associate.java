...
public class Associate extends Entity {
    ...
    protected Associate(String id, Text categoryId, Text code, Text name, Date updateDate, Booleanic active) {
        super(id);
    ...
    public Entity copy() {
        return new Associate(id, categoryId, code, name, updateDate, active);
    }
