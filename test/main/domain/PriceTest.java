...
public class PriceTest {
	...
	@Test
	public void givenaDoubleAsString_itConvertsBackToString(){
		assertEquals("10.0", new Price("10.0").toString());
	}
	
	@Test
	public void givenaDoubleSurroundedBySpaceAsString_itConvertsBackToString(){
		assertEquals("10.0", new Price("    10.0    ").toString());
	}
